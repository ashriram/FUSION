...
string CoherenceResponseType_to_string(const CoherenceResponseType& obj)
{
  ...
  case CoherenceResponseType_DATA:
    return "DATA";
  case CoherenceResponseType_DATA_ATOMIC:
    return "DATA_ATOMIC";
  ...
  case CoherenceResponseType_DATA_ACC:
    return "DATA_ACC";
  default:
...
CoherenceResponseType string_to_CoherenceResponseType(const string& str)
{
  if (false) {
    ...
    return CoherenceResponseType_DATA_ATOMIC;
  } else if (str == "ACK") {
  ...
  } else if (str == "DATA_ACC") {
    return CoherenceResponseType_DATA_ACC;
  } else {
    WARN_EXPR(str);
