...
public:
  ...
  ~L2Cache_Entry() { };
  L2Cache_Entry(const L2Cache_State& local_CacheState, const NetDest& local_Sharers, const MachineID& local_Exclusive, const DataBlock& local_DataBlk, const bool& local_Dirty, const Time& local_liveUntilTime)
  : AbstractCacheEntry()
  {
...
//private:
  ...
  Time m_liveUntilTime; /**< maximum lifetime of the cache block in any of the L1s*/
};
