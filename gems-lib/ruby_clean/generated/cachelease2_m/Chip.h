...
public:
  ...
  void printBufferStats(ostream& out);
...
public: // FIXME - these should not be public
  ...
  Vector < MessageBuffer* >  m_L2Cache_requestFromL2TCache_vec;
  Vector < MessageBuffer* >  m_L2Cache_responseFromL2TCache_vec;
  Vector < MessageBuffer* >  m_L2Cache_unblockFromL2TCache_vec;
  Vector < MessageBuffer* >  m_L2Cache_requestToL2TCache_vec;
  Vector < MessageBuffer* >  m_L2Cache_responseToL2TCache_vec;
  Vector < TBETable<L2Cache_TBE>* >  m_L2Cache_L2_TBEs_vec;
  Vector < CacheMemory<L2Cache_Entry>* >  m_L2Cache_L2cacheMemory_vec;
  Vector < MessageBuffer* >  m_L2Cache_L2ExpireTriggerQueue_vec;
  ...
  GenericRequestType convertRequestToGenericType(CoherenceRequestType param_type);
  GenericRequestType convertResponseToGenericType(CoherenceResponseType param_type);
};
