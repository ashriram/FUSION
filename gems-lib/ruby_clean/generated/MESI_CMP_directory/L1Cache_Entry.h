...
public:
  ...
  ~L1Cache_Entry() { };
  L1Cache_Entry(const L1Cache_State& local_CacheState, const DataBlock& local_DataBlk, const bool& local_Dirty, const ruby_mem_access_byte_mask_t& local_DirtyMask)
  : AbstractCacheEntry()
  {
...
//private:
  ...
  ruby_mem_access_byte_mask_t m_DirtyMask; /**< which bytes have been written to by this private cache?*/
};
