...
public:
  L1Cache_TBE() 
  {
    ...
    m_reqSize = 0; // default for this field 
    m_AccessMask = 0; // default for this field 
  }
  ~L1Cache_TBE() { };
  L1Cache_TBE(const Address& local_Address, const L1Cache_State& local_TBEState, const DataBlock& local_DataBlk, const bool& local_Dirty, const bool& local_isPrefetch, const int& local_pendingAcks, const int& local_reqSize, const ruby_mem_access_byte_mask_t& local_AccessMask)
  {
    ...
    m_reqSize = local_reqSize;
    m_AccessMask = local_AccessMask;
  }
...
/** \brief Const accessor method for reqSize field.
  * \return reqSize field
  */
  const int& getreqSize() const { return m_reqSize; }
/** \brief Const accessor method for AccessMask field.
  * \return AccessMask field
  */
  const ruby_mem_access_byte_mask_t& getAccessMask() const { return m_AccessMask; }
...
/** \brief Non-const accessor method for reqSize field.
  * \return reqSize field
  */
  int& getreqSize() { return m_reqSize; }
/** \brief Non-const accessor method for AccessMask field.
  * \return AccessMask field
  */
  ruby_mem_access_byte_mask_t& getAccessMask() { return m_AccessMask; }
...
/** \brief Mutator method for reqSize field */
  void setreqSize(const int& local_reqSize) { m_reqSize = local_reqSize; }
/** \brief Mutator method for AccessMask field */
  void setAccessMask(const ruby_mem_access_byte_mask_t& local_AccessMask) { m_AccessMask = local_AccessMask; }
...
//private:
  ...
  int m_reqSize; /**< Size of data requested by core*/
  ruby_mem_access_byte_mask_t m_AccessMask; /**< which bytes are being accessed?*/
};
