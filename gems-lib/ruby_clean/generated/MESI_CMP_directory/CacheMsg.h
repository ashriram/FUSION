...
/** \brief Const accessor method for profiled field.
  * \return profiled field
  */
  const bool& getprofiled() const { return m_profiled; }
...
/** \brief Non-const accessor method for profiled field.
  * \return profiled field
  */
  bool& getprofiled() { return m_profiled; }
...
/** \brief Mutator method for profiled field */
  void setprofiled(const bool& local_profiled) { m_profiled = local_profiled; }
...
//private:
  ...
  bool m_profiled; /**< Has the request been profiled yet?*/
