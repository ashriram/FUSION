...
public:
  ...
  : NetworkMessage()
  {
    ...
    m_DirtyMask = 0; // default for this field 
  }
  ~ResponseMsg() { };
  ResponseMsg(const Address& local_Address, const CoherenceResponseType& local_Type, const MachineID& local_Sender, const NetDest& local_Destination, const DataBlock& local_DataBlk, const bool& local_Dirty, const int& local_AckCount, const MessageSizeType& local_MessageSize, const ruby_mem_access_byte_mask_t& local_DirtyMask)
  : NetworkMessage()
  {
...
/** \brief Const accessor method for DirtyMask field.
  * \return DirtyMask field
  */
  const ruby_mem_access_byte_mask_t& getDirtyMask() const { return m_DirtyMask; }
...
/** \brief Non-const accessor method for DirtyMask field.
  * \return DirtyMask field
  */
  ruby_mem_access_byte_mask_t& getDirtyMask() { return m_DirtyMask; }
...
/** \brief Mutator method for DirtyMask field */
  void setDirtyMask(const ruby_mem_access_byte_mask_t& local_DirtyMask) { m_DirtyMask = local_DirtyMask; }
...
//private:
  ...
  ruby_mem_access_byte_mask_t m_DirtyMask; /**< which bytes have been written to (only use for PUTX and WB DATA requests*/
};
